...
public enum AONeighbourInfo {
    ...
    private static final AONeighbourInfo[] VALUES = AONeighbourInfo.values();

    /**
     * @return Returns the {@link AONeighbourInfo} which corresponds with the specified direction
     */
    public static AONeighbourInfo get(EnumFacing direction) {
    ...
    AONeighbourInfo(EnumFacing[] directions, float strength) {
