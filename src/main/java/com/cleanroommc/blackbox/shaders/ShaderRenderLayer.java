...
import com.cleanroommc.blackbox.shaders.core.mixins.RenderGlobalExposer;
import com.cleanroommc.blackbox.shaders.depth.DepthHelpers;
import com.cleanroommc.blackbox.shaders.effects.BloomEffect;
...
public class ShaderRenderLayer {
	...
	public static class Bloom {
		...
		public static int renderLayer(Minecraft minecraft, RenderGlobal renderGlobal, double partialTicks, int pass, Entity entity) {
			...
			((RenderGlobalExposer) renderGlobal).invokeRenderBlockLayer(LAYER);
			...
			int result = renderGlobal.renderBlockLayer(BlockRenderLayer.TRANSLUCENT, partialTicks, pass, entity);
